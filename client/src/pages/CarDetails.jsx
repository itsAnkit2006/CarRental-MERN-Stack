...
const CarDetails = () => {
  ...
  useEffect(() => {
    ...
    if (foundCar) {
      setSelectedImage(foundCar.images?.[0] || foundCar.image);
    }
  }, [cars, id]);
  ...
  "
      >
        <img
          ...
          alt=""
          className="rotate-180 opacity-80 w-4 h-4"
        />
        Back to all cars
      </button>
      ...
      "
          ...
          <div className="flex gap-2 flex-wrap mb-6">
            {(car.images?.length ? car.images : [car.image]).map((img, i) => (
              <img
                key={i}
                src={img}
            ...
            <div className="pt-6 sm:pt-8">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2 bg-white/5 border border-yellow-500/15 px-3 py-1.5 rounded-xl">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 rounded-xl bg-white/5 border border-white/10 text-gray-200 hover:bg-white/10 transition text-xs sm:text-sm"
                  >
                    Refresh
                  </button>
                </div>
              ...
              <div className="space-y-5">
                {reviewLoading ? (
                  ...
                  reviews.map((review) => (
                    <div
                      key={review._id}
                      className="bg-white/5 backdrop-blur-xl border border-yellow-500/10 rounded-2xl p-5 hover:border-yellow-400/30 transition"
                    >

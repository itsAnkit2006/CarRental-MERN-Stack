...
const Verification = () => {
  ...
  const submitVerification = async () => {
    ...
    if (!document) return toast.error("Please upload document photo");
            ...
            ">
                ...
                <div className="mt-6 space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      {document && (
                        <p className="text-yellow-300 text-xs mt-2 font-semibold break-all">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="
                        ...
                        outline-none focus:border-yellow-500/30
                      "
                    >
              ...
              {status === "verified" && (
                <div className="mt-6 rounded-2xl border border-green-500/20 bg-green-500/5 p-5">
                  ...
                  <p className="text-gray-400 text-sm mt-1">
                    You can now book cars smoothly.
                  </p>
                </div>
              )}

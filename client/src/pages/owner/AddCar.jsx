          ...
          <label htmlFor="car-image" className="cursor-pointer">
            {images.length > 0 ? (
              <div className="flex gap-2 flex-wrap">
                {images.map((img, i) => (
                  <img
                    ...
                    className="h-16 w-16 object-cover rounded-xl border border-yellow-500/20"
                  />
                ))}
              </div>
            ) : (
              <img
                ...
                className="h-16 w-16 sm:h-20 sm:w-20 object-cover rounded-2xl bg-white/5 border border-yellow-500/15"
              />
            )}

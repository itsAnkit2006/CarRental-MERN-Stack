export default function About() {
  return (
    <div className="bg-black text-gray-200 min-h-screen px-6 py-16">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-8 leading-relaxed text-gray-300">
          <p>
            ...
            customers with trusted vehicle owners through a seamless and secure
            experience. Our goal is to simplify vehicle access while maintaining
            high standards of safety and reliability.
          </p>

          <p>
            The platform allows users to browse vehicles, schedule bookings,
            complete payments, and manage trips effortlessly. Owners can manage
            listings and verification processes through a dedicated dashboard,
            while administrators ensure system quality and trust.
          </p>

          <p>
            Built using the MERN stack, CarRental focuses on scalable
            architecture, secure authentication, and responsive design patterns
            that reflect production-grade development standards.
          </p>
        </div>

  ...
  return (
    ...
    >
      <div className="px-6 md:px-16 lg:px-24 xl:px-32 pt-24 pb-10 text-sm">
        ...
        <motion.div
          variants={item}
          className="flex flex-wrap justify-between items-start gap-10 pb-10 border-b border-yellow-500/15"
        >
          {/* Brand */}
          <div className="max-w-sm">
            ...
            <motion.p variants={item} className="mt-4 leading-relaxed text-gray-400">
              ...
              {[assets.facebook_logo, assets.instagram_logo, assets.twitter_logo, assets.gmail_logo].map(
                (social, idx) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="
                      p-2 rounded-lg bg-white/5 border border-yellow-500/10
                      hover:border-yellow-400/40 hover:bg-white/10 transition-all
                    "
                  >
        ...
        <motion.div
          variants={item}
          className="flex flex-col md:flex-row gap-3 items-center justify-between pt-6 text-gray-500"
        >
          <p>

...
return ( <div className="w-full bg-[#0B0B0B] py-16 sm:py-20 overflow-hidden">
<motion.div
variants={container}
initial="hidden"
whileInView="show"
...
>
    ...
    {/* Glow Effects */}
    <div className="absolute -top-24 -left-24 w-[320px] sm:w-[420px] h-[320px] sm:h-[420px] bg-yellow-500/15 blur-[120px] rounded-full pointer-events-none" />
    <div className="absolute bottom-0 right-0 w-[320px] sm:w-[420px] h-[320px] sm:h-[420px] bg-yellow-500/10 blur-[140px] rounded-full pointer-events-none" />
    ...
    <div className="relative z-10 text-white max-w-xl text-center lg:text-left">
      ...
      <motion.p
        variants={item}
        className="mt-3 text-gray-400 leading-relaxed text-sm sm:text-base"
      >
    ...
    <motion.img
      ...
      className="
        relative z-10
        max-h-40 sm:max-h-48 md:max-h-52
        mt-8 lg:mt-0
        drop-shadow-[0px_25px_40px_rgba(0,0,0,0.65)]
        select-none
      "
